...
//go:generate swagger generate server --target ../../app --name Usql --spec ../swagger.yaml --principal interface{}

func configureFlags(api *operations.UsqlAPI) {
...
func configureAPI(api *operations.UsqlAPI) http.Handler {
